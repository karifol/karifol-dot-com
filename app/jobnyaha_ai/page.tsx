        ...
        >
          <div className="max-w-2xl px-8 text-center">
            {prologueText.slice(0, displayedLen).split("\n").map((line, i) => (
              <p
                key={i}
                className="text-white/80 text-base sm:text-lg font-light leading-relaxed tracking-wider"
      ...
      >
        ...
        >
          <div
            ...
            style={{
              opacity: !isMobile && hovered === "train" ? 0.5 : 1,
              transform: !isMobile && hovered === "chat" ? "scale(1.05)" : "scale(1)",
            }}
          >
            ...
            <h2 className="text-xl sm:text-3xl font-light tracking-[0.15em] text-white/90">会話する</h2>
      ...
      >
        ...
        >
          <div
            className="flex flex-col items-center gap-4 transition-all duration-500"
            style={{
              opacity: !isMobile && hovered === "chat" ? 0.5 : 1,
              transform: !isMobile && hovered === "train" ? "scale(1.05)" : "scale(1)",
            }}
          >
            <div className="w-16 h-16 rounded-full bg-white/10 backdrop-blur-sm flex items-center justify-center border border-white/20">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} className="w-8 h-8 text-white/80">
            ...
            <h2 className="text-xl sm:text-3xl font-light tracking-[0.15em] text-white/90">育てる</h2>
